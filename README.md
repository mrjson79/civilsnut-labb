...
| **Immich** | `0.12.0` <!-- renovate: datasource=helm depName=immich registryUrl=https://immich-app.github.io/immich-charts --> | Self-hosted photo library (photos.civilsnut.se), CNPG + VectorChord backend |
