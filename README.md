...
| **Prometheus Operator CRDs** | `v0.94.0` <!-- renovate: datasource=github-releases depName=prometheus-operator/prometheus-operator --> | CRDs installed ahead of kube-prometheus-stack |
...
| Application | Version | Purpose |
|-------------|---------|---------|
| **kube-prometheus-stack** | `90.1.1` <!-- renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts --> | Prometheus, Alertmanager, Grafana (Zitadel OIDC SSO) |
