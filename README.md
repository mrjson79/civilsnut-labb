...
| Application | Version | Purpose |
|-------------|---------|---------|
| **Rook-Ceph** | `v1.20.6` <!-- renovate: datasource=helm depName=rook-ceph registryUrl=https://charts.rook.io/release --> (Ceph `v20.2.2`) | Distributed block storage + RGW object store |
...
| Application | Version | Purpose |
|-------------|---------|---------|
| **kube-prometheus-stack** | `88.6.2` <!-- renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts --> | Prometheus, Alertmanager, Grafana (Zitadel OIDC SSO) |
