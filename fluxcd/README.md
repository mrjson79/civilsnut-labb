...
| Component | Version | Purpose |
|-----------|---------|---------|
| **Rook-Ceph** | v1.20.6 <!-- renovate: datasource=helm depName=rook-ceph registryUrl=https://charts.rook.io/release --> | Distributed block storage (operator + cluster) |
...
| Chart | Version | Role |
|-------|---------|------|
| **kube-prometheus-stack** | 88.6.1 <!-- renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts --> | Prometheus, Alertmanager, Grafana, kube-state-metrics, prometheus-operator |
