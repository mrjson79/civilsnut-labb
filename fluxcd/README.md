...
| **Prometheus Operator CRDs** | v0.94.0 <!-- renovate: datasource=github-releases depName=prometheus-operator/prometheus-operator --> | Prometheus Operator custom resource definitions |
...
| Chart | Version | Role |
|-------|---------|------|
| **kube-prometheus-stack** | 90.1.1 <!-- renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts --> | Prometheus, Alertmanager, Grafana, kube-state-metrics, prometheus-operator |
