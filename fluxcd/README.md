...
| Chart | Version | Role |
|-------|---------|------|
| **kube-prometheus-stack** | 88.6.0 <!-- renovate: datasource=helm depName=kube-prometheus-stack registryUrl=https://prometheus-community.github.io/helm-charts --> | Prometheus, Alertmanager, Grafana, kube-state-metrics, prometheus-operator |
